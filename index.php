...
<head>
  ...
  <script type="text/javascript" src="http://s.sharethis.com/loader.js"></script>
    ...
    fbq('init', '208126329535062');
    fbq('track', "PageView");</script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=208126329535062&ev=PageView&noscript=1"
    /></noscript>
  ...
  <section id="goals" class="features-grid pad-top-1 pad-bottom-2 bb-1">
    <div class="container">
      ...
      <header class="heading_1 text-center">
        ...
        <h2 class="main_title">
          <span class="sub_title">Our Goals</span>
          What we <span class="base-highlight">need</span>
        </h2>
      </header>
