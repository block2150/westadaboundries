        ...
        <div class="row-fluid">
            <div class="span8 well">
                ...
                <div class="hero-unit welcome">
                	<div class="row-fluid">
                    	<div class="span3"><img class="img-polaroid" id="profile-image" src="/profile/<?php echo $_SESSION['user_username'] ?>/small_image.png">  </div>
                    	<div class="span9">
                        	<h3><?php echo $_SESSION['user_fullname'] ?> <span class="small"><?php echo $_SESSION['user_type'] ?></span></h3>
                            <textarea id="share-update" placeholder="Share an update with others on fotoluv"></textarea>
                            <button id="share-update-btn" class="btn btn-inverse pull-right" type="button" onClick="homeUpdate();">Share</button>
                        </div>
                    </div>
